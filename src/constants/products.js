...
export const PRODUCTS = [
  ...
  },
  {
    ...
    price: "$700",
    tag: "coffees",
    description2: "Americano suave compuesto por un solo Espresso (30 ml) combinado con agua purificada para obtener una mezcla equilibrada.",
    sizes: null
  },
  {
    title: "Café Latte",
    ...
    price: "$850",
    tag: "coffees",
    description2: "Café Latte cremoso con Espresso (30 ml), leche vaporizada y capa suave de espuma.",
    sizes: {
      small: "$680",
      medium: "$850",
      large: "$1000"
  ...
  },
  {
    ...
    price: "$700",
    tag: "coffees",
    description2: "Cappuccino delicioso con Espresso (30 ml) y generosa espuma de leche para una textura suave y un sabor inconfundible.",
    sizes: {
      small: "$600",
      medium: "$700",
      large: "$800"
  ...
  },
  {
    ...
    price: "$950",
    tag: "coffees",
    description2: "Mocha indulgente con Espresso (30 ml), leche fresca,  chocolate de alta calidad y crema para una experiencia decadente y deliciosa.",
    sizes: {
      small: "$800",
      medium: "$950",
      large: "$1100"
  ...
  },
  {
    ...
    price: "$1200",
    tag: "coffees",
    description2: "Macchiato auténtico con Espresso (30 ml) realzado con un sutil toque de leche o espuma para un equilibrio perfecto de sabores.",
    sizes: {
      small: "$1000",
      medium: "$1200",
      large: "$1400"
  ...
  // ... (otros elementos del menú)
  {
    ...
    price: "$950",
    tag: "salty",
    description2: "Tostado de Jamón y Queso con pan crujiente, jamón premium y queso derretido. Combinación salada y satisfactoria para tu paladar."
  },
  {
    ...
    price: "$700",
    tag: "salty",
    description2: "Croissant relleno de jamón jugoso y queso derretido. Clásico y reconfortante, perfecta fusión de sabores y texturas."
  },
  {
    title: "Avocado Toast",
    ...
    price: "$850",
    tag: "salty",
    description2: "Tostada con aguacate fresco y tomate cherry. Explosión de sabores frescos y texturas irresistibles."
  },
  {
    title: "Panini",
    ...
    price: "$700",
    tag: "salty",
    description2: "Panini tostado con mezcla irresistible de ingredientes frescos. Opción sabrosa y reconfortante para satisfacer tus antojos en cualquier momento."
  },
...
//sweets DULCES
  {
    ...
    price: "$950",
    tag: "sweets",
    description2: "Deliciosa tarta de chocolate para satisfacer tus antojos más dulces."
  },
  {
    title: "Brownie",
    ...
    price: "$700",
    tag: "sweets",
    description2: "Brownie rico y suave, elaborado con chocolate y nueces para una experiencia indulgente."
  },
  {
    ...
    price: "$850",
    tag: "sweets",
    description2: "Cheesecake cremoso con fresas frescas para un postre deliciosamente equilibrado."
  },
  {
    ...
    price: "$700",
    tag: "sweets",
    description2: "Donuts esponjosos y cubiertos con glaseado para una deliciosa indulgencia."
  },
  {
    title: "Tiramisú",
    ...
    price: "$950",
    tag: "sweets",
    description2: "Clásico Tiramisú italiano con capas de bizcocho y crema de mascarpone."
  },
  {
    title: "Croissant",
    ...
    price: "$1200",
    tag: "sweets",
    description2: "Croissant esponjoso relleno de irresistible chocolate para un desayuno o merienda delicioso."
  },
